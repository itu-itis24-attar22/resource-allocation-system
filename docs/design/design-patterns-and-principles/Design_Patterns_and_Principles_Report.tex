...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{images/strategy-pattern.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{images/factory-polymorphism.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{images/facade-pattern.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{images/adapter-pattern.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.1\textwidth]{images/rule-polymorphism.png}
